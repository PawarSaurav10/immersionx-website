...
const OurWork = () => {
  ...
  const WNSData = {
    ...
    data1: {
      ...
      h2: "The Welcome Zone",
      p3: "The welcome zone controlled by the Digital Toolkit, welcomes the visitor. The DTK app, gives the user the option to upload the client’s credentials, relevant content, in the form of visuals and videos and give a personalized welcome message."
    },
    data2: {
      numberofcolspan: 2,
      imageurl: img2,
      ...
      <div className="flex p-2">
        <div className="px-2 flex-1 flex flex-col">
          ...
          <div className="portfolio-item img-zoom ct-marketing ct-media ct-branding ct-marketing ct-webdesign py-2 ">
            <div className="portfolio-item-wrap">
              <div className="portfolio-image">
                <Link to="/work-detail" state={{ data: WNSData }}><img src={img1} alt="" /></Link>
              </div>
          ...
          <div className="portfolio-item img-zoom ct-marketing ct-media ct-branding ct-marketing ct-webdesign py-2">
            <div className="portfolio-item-wrap">
              <div className="portfolio-image">
                <Link to="/work-detail" state={{ data: KanakiaData }}><img src={img2} alt="" /></Link>
              </div>
              <div className="portfolio-description" style={{ bottom: "-40px", display: "flex", justifyContent: "flex-start" }}>
                <Link to="/work-detail" state={{ data: KanakiaData }}>
                  <div className="text-base md:text-3xl font-bold text-white">KANAKIA</div>
                  {/* <span>Graphics</span> */}
                </Link>
              </div>
            </div>
          ...
          <div className="portfolio-item img-zoom ct-marketing ct-media ct-branding ct-marketing ct-webdesign py-2">
            <div className="portfolio-item-wrap">
              <div className="portfolio-image">
                <Link to="/work-detail" state={{ data: GroheData }}><img src={img3} alt="" /></Link>
              </div>
              <div className="portfolio-description" style={{ bottom: "-40px", display: "flex", justifyContent: "flex-start" }}>
                <Link to="/work-detail" state={{ data: GroheData }}>
                  <div className="text-base md:text-3xl font-bold text-white">GROHE</div>
                  {/* <span>Graphics</span> */}
                </Link>
              </div>
            </div>
        ...
        <div className="flex-1 px-2 flex flex-col">
          <div className="portfolio-item img-zoom ct-marketing ct-media ct-branding ct-marketing ct-webdesign py-2">
            <div className="portfolio-item-wrap">
              <div className="portfolio-image">
                <Link to="/work-detail" state={{ data: TCLData }}><img src={img4} alt="" /></Link>
              </div>
              <div className="portfolio-description" style={{ bottom: "-40px", display: "flex", justifyContent: "flex-start" }}>
            ...
            <div className="portfolio-item-wrap">
              <div className="portfolio-image">
                <Link to="/work-detail" state={{ data: AudiData }}><img src={img5} alt="" /></Link>
              </div>
              <div className="portfolio-description" style={{ bottom: "-40px", display: "flex", justifyContent: "flex-start" }}>
                <Link to="/work-detail" state={{ data: AudiData }}>
                  <div className="text-base md:text-3xl font-bold text-white">AUDI</div>
                  {/* <span>Graphics</span> */}
                </Link>
              </div>
            </div>
            ...
            <div className="portfolio-item-wrap">
              <div className="portfolio-image">
                <Link to="/work-detail" state={{ data: SiemensData }}><img src={img6} alt="" /></Link>
              </div>
              <div className="portfolio-description" style={{ bottom: "-40px", display: "flex", justifyContent: "flex-start" }}>
                <Link to="/work-detail" state={{ data: SiemensData }}>
                  <div className="text-base md:text-3xl font-bold text-white">SIEMENS</div>
                  {/* <span>Graphics</span> */}
                </Link>
              </div>
            </div>
            ...
            <div className="portfolio-item-wrap">
              <div className="portfolio-image">
                <Link to="/work-detail" state={{ data: LegerandData }}><img src={img7} alt="" /></Link>
              </div>
              <div className="portfolio-description" style={{ bottom: "-40px", display: "flex", justifyContent: "flex-start" }}>
                <Link to="/work-detail" state={{ data: LegerandData }}>
                  <div className="text-base md:text-3xl font-bold text-white">LEGERAND</div>
                  {/* <span>Graphics</span> */}
                </Link>
              </div>
            </div>
