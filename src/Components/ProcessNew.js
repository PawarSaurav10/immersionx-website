            ...
            <div className="relative mb-12">
              ...
              <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 text-white text-center ">
                <div className="flex flex-col justify-center pt-20">
                  ...
                  <div className="text-sm w-64 max-w-full mx-auto">
                    Our team of designers, developers, engineers, marketers and
                    tech experts successfully execute projects that are not just
                    solution based but also a visual masterpiece.
                  </div>
                </div>
              </div>
            </div>
