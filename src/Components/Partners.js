...
const Partners = () => {
  ...
  return (
    <div className=" bg-our-partners bg-no-repeat bg-cover lg:h-screen">
            ...
            <div className="pt-0 lg:pt-32">
              <Fade left>
                <div className="text-white text-left max-w-sm text-base xl:text-lg pb-6 lg:pb-0">
                  ...
                  <div>
                    We are elated to have partners across the globe that provide
                    expertise to help us deliver our end goal.
                  </div>
                </div>
              </Fade>
            </div>
