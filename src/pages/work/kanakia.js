...
const Kanakia = ({ location }) => {
  const KanakiaData = {
    ...
    data2: {
      ...
      p3: "With meticulous attention to detail, the team transferred the entire setup with decimal level accuracy from workshop to site. With all the pointers on the checklist tick-marked. it is safe to safe that WE delivered as promised.",
