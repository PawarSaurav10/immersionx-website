...
const Legrand = ({ location }) => {
  const LegerandData = {
    ...
    data2: {
      ...
      // h1: "Our Approach",
      p1: "A beautifully designed story was curated around their new products which would at first showcase the product's functionality within the 3d house and then elaborate its features in detail with pop up 3d animations, all of this which was then broadcasted live on YouTube.",
